      ...
      .then((data) => {
        ...
        $("#geol").prepend(
          `<h5>Your Location Is Detected As</h5>` +
            `<h3> <i class="fas fa-street-view"></i> ${
        ...
        fetch(url4)
          ...
          .then((data) => {
            console.log(data);
            $("#weather").prepend(
              `<h5>Current Weather at your location is :</h5>` +
                `<h4> <i class="fas fa-cloud-sun-rain"></i> ${
        ...
        fetch(url5)
          ...
          .then(function (data) {
            ...
            // console.log(data[0]);
            $("#qut").prepend(
              `<b>Quote For the Day</b> <i class="fas fa-users text-dark"></i><br><h6>Author - ${data[x].author}</h6> ` +
                `<h4> ${data[x].text}</h4>`
            );
          });
      });
